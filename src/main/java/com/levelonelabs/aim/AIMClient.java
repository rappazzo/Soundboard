...
public class AIMClient implements Runnable, AIMSender {
    ...
    private static long BETWEEN_MESSAGES = 500;
     ...
     */
    public void sendToMultiple(String message, List<AIMBuddy> buddies) {
       if (buddies != null) {
          //clean up the list
          StringBuilder buf = new StringBuilder();
          for (AIMBuddy buddy : buddies) {
             if (!buddy.isBanned() && buddy.isOnline()) {
                buf.append(buddy.getName());
             }
          }
          if (buf.length() > 0) {
             //$MR todo
    ...
    public void addBuddies(List<AIMBuddy> buddyList) {
        ...
        Iterator<String> groupIter = groupMap.keySet().iterator();
        while (groupIter.hasNext()) {
            String group = groupIter.next();
            String currentlist = "toc2_new_buddies {g:" + group + "\n";
            List groupList = groupMap.get(group);
     ...
     */
    private Map<String, List<AIMBuddy>> createGroupMap(List<AIMBuddy> buddyList) {
        ...
        for (Iterator<AIMBuddy> iter = buddyList.iterator(); iter.hasNext();) {
    ...
    private void generateMessage(String from, String request) {
        ...
        if (aimbud.isBanned()) {
            ...
            for (int i = 0; i < aimListeners.size(); i++) {
                try {
                    aimListeners.get(i).handleMessage(aimbud, request);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    private void generateWarning(String from, int amount) {
        ...
        for (int i = 0; i < aimListeners.size(); i++) {
            try {
                aimListeners.get(i).handleWarning(aimbud, amount);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    private void generateConnected() {
        for (int i = 0; i < aimListeners.size(); i++) {
            try {
                aimListeners.get(i).handleConnected();
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    private void generateDisconnected() {
        for (int i = 0; i < aimListeners.size(); i++) {
            try {
                aimListeners.get(i).handleDisconnected();
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    private void generateError(String error, String message) {
        for (int i = 0; i < aimListeners.size(); i++) {
            try {
                aimListeners.get(i).handleError(error, message);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    private void generateBuddySignOn(String buddy, String message) {
        ...
        if (!aimbud.isOnline()) {
            ...
            for (int i = 0; i < aimListeners.size(); i++) {
                try {
                    aimListeners.get(i).handleBuddySignOn(aimbud, message);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    private void generateBuddySignOff(String buddy, String message) {
        ...
        for (int i = 0; i < aimListeners.size(); i++) {
            try {
                aimListeners.get(i).handleBuddySignOff(aimbud, message);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    private void generateBuddyAvailable(String buddy, String message) {
        ...
        for (int i = 0; i < aimListeners.size(); i++) {
            try {
                aimListeners.get(i).handleBuddyAvailable(aimbud, message);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    private void generateBuddyUnavailable(String buddy, String message) {
        ...
        for (int i = 0; i < aimListeners.size(); i++) {
            try {
                aimListeners.get(i).handleBuddyUnavailable(aimbud, message);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
