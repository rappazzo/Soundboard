...
public interface DistributedSession extends Session {
     ...
     * <p/>
     * Please note that when not running in the distributed environment, this map behaves similarly to {@link #getUserProperties()},
     * so no serialization or deserialization is performed when values are read from or stored to the returned map.
     *
