...
public class UnsubscribeAsClientCommand extends Command {
   ...
   @Override public String getDescription() {
      return "Unsubscribe to client messages.";
   }
   ...
   @Override  public String execute(InputService inputService, String who, String[] args, boolean isCron, boolean respondWithHtml) {
      ...
      LoggingService.getInstance().removeClient(who, inputService.getClass().getName());
      return "ACKNOWLEDGED";
   }
