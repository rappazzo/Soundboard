...
public class NamedThreadFactory implements ThreadFactory {
   ...
   public static NamedThreadFactory daemons(String namePrefix) {
      return new NamedThreadFactory(namePrefix, true);
   }

   public static NamedThreadFactory mains(String namePrefix) {
      return new NamedThreadFactory(namePrefix, false);
   }

   /**
    * Constructors...is the default constructor logical?
    */
