...
import repackaged.soundboard.com.ullink.slack.simpleslackapi.events.EventType;
...
class SlackJSONMessageParser
{
    public static enum SlackMessageSubType
    {
        ...
        private static final Map<String, SlackMessageSubType> CODE_MAP = new HashMap<String, SlackMessageSubType>();
