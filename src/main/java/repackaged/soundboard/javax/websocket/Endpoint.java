 ...
 * holder.
 */
package repackaged.soundboard.javax.websocket;
 ...
 * the {@link Endpoint#onOpen(repackaged.soundboard.javax.websocket.Session, repackaged.soundboard.javax.websocket.EndpointConfig) onOpen} method, the programmatic endpoint gains access to the {@link Session} object, 
 ...
 * {@link repackaged.soundboard.javax.websocket.server.ServerEndpointConfig.Configurator#getEndpointInstance} 
 * method to obtain the 
 * endpoint instance it will use for each new client connection.  If the developer uses 
 * the default {@link repackaged.soundboard.javax.websocket.server.ServerEndpointConfig.Configurator}, 
 ...
 * at a time.
 * 
 * <p>If the developer provides a custom {@link repackaged.soundboard.javax.websocket.server.ServerEndpointConfig.Configurator}
