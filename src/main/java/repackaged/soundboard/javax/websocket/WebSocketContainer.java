...
public interface WebSocketContainer {
     ...
     * {@link repackaged.soundboard.javax.websocket.server.ServerEndpoint} annotation. This method 
     ...
     * {@link repackaged.soundboard.javax.websocket.server.ServerEndpoint} annotation. This method blocks until the connection
     ...
     * example, when the implementation is part of the Java EE platform
     * may not be available. If the client endpoint uses dependency injection,
     * use {@link WebSocketContainer#connectToServer(java.lang.Class, repackaged.soundboard.javax.websocket.ClientEndpointConfig, java.net.URI) }
     * instead.
     *
