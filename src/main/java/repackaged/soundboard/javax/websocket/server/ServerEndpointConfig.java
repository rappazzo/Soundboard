 ...
 * holder.
 */
package repackaged.soundboard.javax.websocket.server;
...
public interface ServerEndpointConfig extends EndpointConfig {
     ...
     * {@link ServerEndpointConfig.Builder#configurator(repackaged.soundboard.javax.websocket.server.ServerEndpointConfig.Configurator) }
    ...
    */
    public class Configurator {
        ...
        static ServerEndpointConfig.Configurator fetchContainerDefaultConfigurator() {
            for (ServerEndpointConfig.Configurator impl : ServiceLoader.load(repackaged.soundboard.javax.websocket.server.ServerEndpointConfig.Configurator.class)) {
                return impl;
            }
